        ...
        <ul class="menu-sub">
            ...
            <li class="menu-item">
                <a href="#" class="menu-link menu-toggle">
                    ...
                    <div class="d-flex justify-content-between w-100 align-items-center" data-i18n="User">
                        <span>Users</span>
                        <i class="ri-arrow-down-s-line toggle-icon"></i>
                    </div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="{{ route('profilehub.admin.users') }}" class="menu-link">
                            <div class="d-flex justify-content-between w-100 align-items-center" data-i18n="All Users">All
                                Users</div>
                        </a>
                    </li>
            ...
            <li class="menu-item">
                <a href="#" class="menu-link menu-toggle">
                    ...
                    <div class="d-flex justify-content-between w-100 align-items-center" data-i18n="Profile Fields">
