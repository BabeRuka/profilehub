@if (Auth::check())
    ...
    <div class="ms-auto dropdown">
        <a href="#" class="d-flex align-items-center text-dark text-decoration-none dropdown-toggle" id="profileDropdown"
            ...
            <img src="{{ asset('vendor/profilehub/images/avatar-blue.png') }}" class="profile-avatar me-2" alt="profile" class="rounded-circle me-2"> 
        </a>
        <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li>
                <div class="d-grid px-4 pt-2 pb-1">
                    <a class="btn btn-primary d-flex btn-sm mb-2" href="{{ route('profilehub.admin.profile.edit') }}">
                        {{ __('Edit Profile') }}
                        <i class="ri-user-settings-line ms-2 ri-16px"></i>
                    </a>

                    <a class="btn btn-danger d-flex btn-sm" href="{{ route('logout') }}"
