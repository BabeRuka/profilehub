...
@endphp
<label class="font-weight-bold">Page Input Settings</label>
<hr />

<div class="row mb-3">
    <div class="col-xl-6 col-md-6 col-xxl-6 col-xs-12 col-sm-12 mb-3">
        <label>Groups</label>
...
<label class="font-weight-bold">Additional Fields</label>
<hr />
