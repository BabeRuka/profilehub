...
<div class="col-lg-4 col-md-6">
    <div class="mt-4">
        <div class="modal fade" id="addCountryModal" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
                    ...
                    <form method="POST" action="{{ route('profilehub.admin.countries.createrecord') }}" id="createGroupForm"
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title text-uppercase fw-bold">
                                ...
                                <span id="addCountryModalTitle">Add Country</span>
                            </h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <h3 class="text-primary fs-6 fw-bold" id="addCountryModalHeading"></h3>
                                <div class="col 12">
                                    @include('profilehub::admin.countries.forms.add-country-form')
                                </div>
                            </div>
