...
<div class="col-lg-4 col-md-6">
    <div class="mt-4">
        <div class="modal fade" id="addUserGroup" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
            data-bs-keyboard="false">
            <div class="modal-dialog modal-fullscreen modal-halfpage" role="document">
                <div class="modal-content">
                    <form method="POST" action="{{ action('AdminUserDetailsController@createrecord') }}"
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <h3 class="text-primary fs-6 fw-bold" id="addUserGroupHeading"></h3>
                                <div class="col 12">
                                    @include('profilehub::admin.users.profile.forms.add-profile-group-form')
                                </div>
                            </div>
