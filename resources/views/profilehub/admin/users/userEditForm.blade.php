                            ...
                            <div class="card-body">
                                ...
                                <div class="form-line">
                                    <div class="form-floating form-floating-outline mb-6">
                                        ...
                                        <input type="text" id="username" name="username" value="{{ $user_detail->username }}"
                                ...
                                <div class="form-line">
                                    <div class="form-floating form-floating-outline mb-6">
                                        ...
                                        <input type="text" id="firstname" name="firstname" value="{{ $user_detail->firstname }}"
                                ...
                                <div class="form-line">
                                    <div class="form-floating form-floating-outline mb-6">
                                        ...
                                        <input type="text" id="lastname" name="lastname" value="{{ $user_detail->lastname }}"
                                            ...
                                            <div class="form-floating form-floating-outline mb-6">
                                                ...
                                                <select class="form-control p-2" id="user_entry_{{ $field->field_id }}"
                                                    ...
                                                    @foreach ($userdetails->user_field_son($field->field_id) as $son)
                                                        <option value="{{ $son->son_id }}" {{ ($son->translation == $userdetails->one_user_field_details($field->field_id, $user->id) ? 'selected="selected"' : '') }}>
                                        ...
                                        <div class="form-line">
                                            <div class="form-floating form-floating-outline mb-6">
                                                ...
                                                <input type="text" id="user_entry_{{ $field->field_id }}"
                                                    name="user_entry[{{ $field->field_id }}]" value="{{ $userdetails->one_user_field_details($field->field_id, $user->id) }}"
