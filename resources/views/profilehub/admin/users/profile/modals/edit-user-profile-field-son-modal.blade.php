...
<div class="col-lg-4 col-md-6"> 
    <div class="mt-4">
        <div class="modal fade" id="editUserFieldSon" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
                    ...
                    <form method="POST" action="{{ route('profilehub.admin.users.groups.userdetails.createrecord') }}"
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title text-uppercase fw-bold">
                                <span id="editUserFieldSonIcon"><i
                                        class="ri-book-open-fill text-primary text-secondary"></i></span>
                                <span id="editUserFieldSonTitle">Edit User Profile Field</span>
                            </h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <h3 class="text-primary fs-6 fw-bold" id="editUserFieldSonHeading"></h3>
                                <div class="col 12">
                                    @include('profilehub::admin.users.profile.forms.edit-profile-field-son-form')
                                </div>
                            </div>
