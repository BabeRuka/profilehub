...
<div class="col-lg-4 col-md-6"> 
    <div class="mt-4">
        <div class="modal fade" id="addUserField" tabindex="-1" aria-hidden="true" data-bs-backdrop="static"
                    ...
                    <form method="POST" action="{{ route('profilehub::admin.users.profile.userdetails.createrecord') }}"
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title text-uppercase fw-bold">
                                <span id="addUserFieldIcon"><i
                                        class="ri-book-open-fill text-primary text-secondary"></i></span>
                                <span id="addUserFieldTitle">Add User Profile Field</span>
                            </h5>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <h3 class="text-primary fs-6 fw-bold" id="addUserFieldHeading"></h3>
                                <div class="col 12">
                                    @include('profilehub::admin.users.profile.forms.add-profile-field-form')
                                </div>
                            </div>
