...
@section('content')
    <form class="needs-validation" action="{{ route('profilehub.admin.profile.createrecord') }}" method="POST" enctype="multipart/form-data"
        novalidate>
        @csrf
        @method('POST')
                        ...
                        @if ($page_layout->first()->page_data == 'full')
                            ...
                            <div class="col-xs-12	col-sm-12	col-md-12	col-lg-12 col-md-8">
                                ...
                                <div class="mb-6 mt-6">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-md-8">
                                            <button class="btn btn-danger active float-right me-3" type="submit" id="saveProfile">
                                                <i class="fas fa-save me-1"></i> {{ __('Save 1') }}
                                            </button> 
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card two_cards_left">
                                    ...
                                    <div class="card-footer">
                                        <div class="row mb-6 mt-6">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-md-8">
                                                <button class="btn btn-danger active float-right" type="submit" id="saveProfile">
