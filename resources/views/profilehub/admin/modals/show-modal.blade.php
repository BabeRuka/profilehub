                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-uppercase fw-bold"><i class="ri-close-circle-fill text-danger"></i>
                            <span id="showModalTitle"></span></h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col 12">
                                <div class="">
                                    <h3 class="text-danger fs-6 fw-bold" id="showModalHeading">Careful! proceed with
                                        caution!</h3>
                                    <p class="text-danger" id="showModalMsg">Are you sure you want to delete this?</p>
                                </div>
                            </div>
                        </div>
