...
class ProfileController extends Controller
{
    ...
    public function index(Request $request): View|Response
    {
        ...
        return view('vendor.profilehub.admin.user.userShow',
        [
                'user' => $user,
                'you' => $you,
                'force' => $force,
    ...
    public function show($id): View|Response
    {
        ...
        return view(
            'vendor.profilehub.admin.user.userShow',
            [
                'user' => $user,
                'force' => $force,
                'page_perm' => $page_perm,
    ...
    public function edit(Request $request): View|Response
    {
        ...
        return view('vendor.profilehub.admin.user.userEdit', compact(
            'user_detail' ,
    ...
    public function force(Request $request): View|Response
    {
        ...
        return view(
            'vendor.profilehub.admin.user.forceProfile',
            [
                'user' => $user,
                'page_perm' => $page_perm,
