...
class AdminUserDetailsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $user_id = Auth::id();
        return view('vendor.profilehub.admin.users.profile.usersDetails')->with(compact([ 'group_id', 'group', 'user_fields', 'user_field_type', 'user_groups', 'page_perm','page_title']));
    }
